...
export const SUMMARY_LANGUAGE_OPTIONS = ["English", "Dutch", "Portuguese", "Spanish", "German", "Russian"] as const;
...
export function buildSummarySystemPrompt(style: SummaryStyle, pageLanguage?: string, outputLanguage?: SummaryLanguage): string {
...
export function buildPageContent(input: { title: string; url: string; language?: string; content: string }): string {
